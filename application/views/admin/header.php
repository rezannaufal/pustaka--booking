...
<html>
<head>
	<title>Halaman Utama - Aplikasi Perpustakaan</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="<?php echo base_url().'admin'; ?>"><span class="glyphicon glyphicon-home"></span> Halaman Utama <span class="sronly">(current)</span></a></li>
